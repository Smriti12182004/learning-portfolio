...
- Developed comparison program.
- Executed program using Python 3.8.
- Executed program using Python 3.12.
...
Through the completed tasks, I gained practical experience in:
